...
export async function sendOTPPhone(phone: string, otp: string) {
    const apiUrl = `https://sms.nettyfish.com/api/v2/SendSMS?SenderId=UEDCAT&Message=OTP%20for%20your%20USTUDYGLOBAL%20of%20UEDUCATE%20Registration%20is%20${otp}&MobileNumbers=${phone}&TemplateId=1707174895339930133&ApiKey=%2Fd%2Ftekofpc1BcUeAz9kz2VFpDSfk1MUwQCGZgvTE7BA%3D&ClientId=a75cb3b3-7b6e-4f63-8b87-ce67790724c4`;
